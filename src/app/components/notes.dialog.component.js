...
var NotesDialogComponent = (function (_super) {
    __extends(NotesDialogComponent, _super);
    function NotesDialogComponent(dialogService) {
        _super.call(this, dialogService);
    }
    NotesDialogComponent.prototype.confirm = function () {
        this.obj = {
            name: this.name,
...
exports.NotesDialogComponent = NotesDialogComponent;
//# sourceMappingURL=notes.dialog.component.js.map