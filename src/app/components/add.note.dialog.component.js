...
var AddNoteDialogComponent = (function (_super) {
    __extends(AddNoteDialogComponent, _super);
    function AddNoteDialogComponent(dialogService) {
        _super.call(this, dialogService);
    }
    AddNoteDialogComponent.prototype.confirm = function () {
        this.obj = {
            name: this.name,
            text: this.text,
            ok: true
...
//# sourceMappingURL=add.note.dialog.component.js.map