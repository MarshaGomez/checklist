...
var AddTaskDialogComponent = (function (_super) {
    __extends(AddTaskDialogComponent, _super);
    function AddTaskDialogComponent(dialogService) {
        _super.call(this, dialogService);
    }
    AddTaskDialogComponent.prototype.confirm = function () {
        this.obj = {
            name: this.name,
